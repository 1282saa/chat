...
import ConversationDrawer from "../news/chat/ConversationDrawer";
...
const AdminView = () => {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-dark-primary transition-colors duration-300">
      ...
      {/* 우측 프롬프트 카드 사이드바 */}
      <div
        className={`fixed right-0 top-0 h-full bg-white dark:bg-dark-secondary border-l border-gray-200 dark:border-gray-700 transition-all duration-500 ease-out z-30 ${
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-hidden">
            {/* PromptCardManager component was removed, so this div will be empty or contain placeholder content */}
            {/* For now, it's empty as the component is removed */}
          </div>
        </div>
      </div>
